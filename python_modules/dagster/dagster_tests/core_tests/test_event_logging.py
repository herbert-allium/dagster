...
def test_event_forward_compat_with_event_specific_data():
    result = deserialize(SERIALIZED_EVENT_FROM_THE_FUTURE_WITH_EVENT_SPECIFIC_DATA, DagsterEvent)
...
def test_event_forward_compat_without_event_specific_data():
    result = deserialize(SERIALIZED_EVENT_FROM_THE_FUTURE_WITHOUT_EVENT_SPECIFIC_DATA, DagsterEvent)
