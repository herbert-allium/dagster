...
from dagster._serdes import deserialize, serialize, whitelist_for_serdes
...
class DagsterApiServer(DagsterApiServicer):
    ...
    def ExecutionPlanSnapshot(self, request, _context):
        execution_plan_args = deserialize(
        ...
        return api_pb2.ExecutionPlanSnapshotReply(
            serialized_execution_plan_snapshot=serialize(execution_plan_snapshot_or_error)
        )

    def ListRepositories(self, request, _context) -> api_pb2.ListRepositoriesReply:
        if self._serializable_load_error:
            return api_pb2.ListRepositoriesReply(
                serialized_list_repositories_response_or_error=serialize(
        ...
        return api_pb2.ListRepositoriesReply(
            serialized_list_repositories_response_or_error=serialize(response)
        )

    def ExternalPartitionNames(self, request, _context) -> api_pb2.ExternalPartitionNamesReply:
        partition_names_args = deserialize(
            request.serialized_partition_names_args,
            PartitionNamesArgs,
        )
        return api_pb2.ExternalPartitionNamesReply(
            serialized_external_partition_names_or_external_partition_execution_error=serialize(
                get_partition_names(
    ...
    def ExternalPartitionConfig(self, request, _context):
        args = deserialize(request.serialized_partition_args, PartitionArgs)
    ...
    def ExternalPartitionTags(self, request, _context) -> api_pb2.ExternalPartitionTagsReply:
        partition_args = deserialize(request.serialized_partition_args, PartitionArgs)
    ...
    def ExternalJob(self, request, _context) -> api_pb2.ExternalJobReply:
        try:
            ...
            ser_job_data = serialize(external_pipeline_data_from_def(job_def))
            return api_pb2.ExternalJobReply(serialized_job_data=ser_job_data)
        except Exception:
            return api_pb2.ExternalJobReply(
                serialized_error=serialize(serializable_error_info_from_exc_info(sys.exc_info()))
            )
    ...
    def ExternalScheduleExecution(self, request, _context):
        ...
        serialized_schedule_data = serialize(
            get_external_schedule_execution(
                self._get_repo_for_origin(args.repository_origin),
                args.instance_ref,
                args.schedule_name,
    ...
    def ExternalSensorExecution(self, request, _context):
        ...
        serialized_sensor_data = serialize(
            get_external_sensor_execution(
                self._get_repo_for_origin(args.repository_origin),
                args.instance_ref,
                args.sensor_name,
    ...
    def ShutdownServer(self, request, _context) -> api_pb2.ShutdownServerReply:
        try:
            ...
            return api_pb2.ShutdownServerReply(
                serialized_shutdown_server_result=serialize(
    ...
    def CancelExecution(self, request, _context):
        ...
        try:
            cancel_execution_request = deserialize(
        ...
        return api_pb2.CancelExecutionReply(
            serialized_cancel_execution_result=serialize(
                CancelExecutionResult(
                    success=success,
                    message=message,
    ...
    def CanCancelExecution(self, request, _context) -> api_pb2.CanCancelExecutionReply:
        can_cancel_execution_request = deserialize(
        ...
        return api_pb2.CanCancelExecutionReply(
            serialized_can_cancel_execution_result=serialize(
    ...
    def StartRun(self, request, _context) -> api_pb2.StartRunReply:
        if self._shutdown_once_executions_finish_event.is_set():
            return api_pb2.StartRunReply(
                serialized_start_run_result=serialize(
                    StartRunResult(
                        success=False,
        ...
        try:
            execute_external_pipeline_args = deserialize(
    ...
    def GetCurrentImage(self, request, _context):
        return api_pb2.GetCurrentImageReply(
            serialized_current_image=serialize(
                GetCurrentImageResult(
    ...
    def GetCurrentRuns(self, request, context) -> api_pb2.GetCurrentRunsReply:
        with self._execution_lock:
            return api_pb2.GetCurrentRunsReply(
                serialized_current_runs=serialize(
                    GetCurrentRunsResult(
...
def open_server_process(
    ...
    subprocess_args = (
        ...
        + (["--instance-ref", serialize(instance_ref)])
