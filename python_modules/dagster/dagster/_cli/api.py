...
from dagster._serdes import deserialize, serialize
...
def execute_run_command(input_json):
    with capture_interrupts():
        args = deserialize(input_json, ExecuteRunArgs)
...
def resume_run_command(input_json):
    with capture_interrupts():
        args = deserialize(input_json, ResumeRunArgs)
...
def execute_step_command(input_json, compressed_input_json):
    with capture_interrupts():
        ...
        args = deserialize(input_json, ExecuteStepArgs)
    ...
    **kwargs,
    ...
    with ExitStack() as exit_stack:
        ...
        server = DagsterGrpcServer(
            ...
            instance_ref=deserialize(instance_ref, InstanceRef) if instance_ref else None,
